...
from testing.test_list_ex_3.integer_list import IntegerList
...
class TestIntegerList(TestCase):
    ...
    def test_add_operation_with_float_element_raises_exception(self):
        with self.assertRaises(ValueError) as ve:
            self.integer_list.add(5.5)

        self.assertEqual("Element is not Integer", str(ve.exception))

    def test_remove_index_operation_with_out_index_raises_index_error(self):
    ...
    def test_insert_integer_on_valid_index_expect_inserted_element(self):
    ...
    def test_insert_float_element_raises_value_error(self):
        with self.assertRaises(ValueError) as ve:
